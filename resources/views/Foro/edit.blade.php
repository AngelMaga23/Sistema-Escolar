...
<div class="card shadow">
    <div class="card-header border-0">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="mb-0">Editar foro</h3>
            </div>
            <div class="col text-right">
            <a href="{{ url('foro/'.$foro->idclase_asig) }}" class="btn btn-sm btn-danger">
                    Cancelar y volver
            </a>
            </div>
        </div>
    ...
    <div class="card-body">
        ...
        <form id="form_foro_edit" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-row">
                        ...
                        <input type="hidden" name="idclase" value="{{ $foro->idclase_asig }}">
                        <div class="form-group col-md-12">
                            <label for="nombre">Nombre de la publicación</label>
                            <input type="text" name="nombre" id="nombre" class="form-control" value="{{ $foro->nombre }}">
                        </div>
